...
class Labirinto(object):
    ...
    def criaLabirinto(self): # cria o labirinto aleatorio
    ...
    def converteLab(self,lab):# converte o labirinto para uma nova estrutura para facilitar o controle
        labirinto=[]
    ...
    def desenhaLabirinto(self,locx,locy):# responsavel por criar a localizacao dos componentes do labirinto na janela
       inicio=locx
       lstBlocos=[]
       lstMatos=[]
       lstinicioFim=[]
    ...
    def geraCoordenada(self): # gera as coordenadas aleatorias
        linha=randint(0,len(self.lstComponentes)-2)
        coluna=randint(0,len(self.lstComponentes[0])-2)
        return(linha,coluna)

    def escolheFimInicio(self): # determina o inicio e o final do labirinto
